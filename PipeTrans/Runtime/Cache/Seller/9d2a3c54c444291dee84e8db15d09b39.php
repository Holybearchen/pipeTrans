...
<head>
    ...
    <script type="text/javascript" src="/pipetrans/Public/Js/Seller/clickbutton.js"></script>
</head>
<body>
        ...
        <div class="col-md-2">
            <div class="list-group">
                <a href="/pipetrans/index.php/seller/order/index" class="list-group-item active">
                    <span class="badge"><?php echo ($newcounter[0]['count(*)']); ?></span>新订单
                </a>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">                    
                    <div class="row">
                            ...
                            <div class="col-md-3 text-left"><?php echo ($detail[0]['orderid']); ?></div>
                            <div class="col-md-2 text-right"><strong>买家姓名：</strong></div>
                            <div class="col-md-4 text-left"><?php echo ($detail[0]['name']); ?></div>
                    </div>
                    <br/>
                    <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-2 text-right"><strong>订单商品：</strong></div>
                            <div class="col-md-9 text-left"><?php echo ($detail[0]['itemname']); ?></div>
                    </div>
                    <br/>
                    <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-2 text-right"><strong>商品单价：</strong></div>
                            <div class="col-md-3 text-left money">￥<?php echo ($detail[0]['price']); ?></div>
                            <div class="col-md-2 text-right"><strong>订货数量：</strong></div>
                            <div class="col-md-4 text-left"><?php echo ($detail[0]['quantity']); ?></div>
                    </div>
                    <br/>
                    <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-2 text-right"><strong>收货地址：</strong></div>
                            <div class="col-md-9 text-left"><?php echo ($detail[0]['province']); echo ($detail[0]['city']); echo ($detail[0]['area']); echo ($detail[0]['address']); ?></div>
                    </div>
                    <br/>
                    <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-2 text-right"><strong>联系电话：</strong></div>
                            <div class="col-md-9 text-left"><?php echo ($detail[0]['phone']); ?></div>
                    </div>
                    <br/>
                    <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-2 text-right"><strong>总金额：</strong></div>
                            <div class="col-md-3 text-left money">￥<?php echo ($detail[0]['totalprice']); ?></div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3 text-left"><?php echo ($detail[0]['orderdate']); ?> 19:19:10
                            </div>
                    ...
                    <div class="row text-center">
                            ...
                            <button type="button" class="btn btn-primary" onclick="accept(<?php echo ($detail[0]['orderid']); ?>)">确定</button>
                    </div>
                </div>
            </div>
        </div>
